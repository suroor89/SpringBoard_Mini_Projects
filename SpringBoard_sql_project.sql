...
SELECT facid, name, name, membercost, monthlymaintenance
FROM Facilities
...
WHERE joindate = (
                    ...
                    WHERE members.memid = members.memid);
...
SELECT F.name as 'Facility Name', CONCAT(M.firstname, ' ',M.surname) as 'Member Name',
CASE WHEN B.memid = 0
...
/* Subquerie are reduse cost and speed up the query run time */
